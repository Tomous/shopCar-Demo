...
@interface DCShoppingTableView ()<ShoppingTableViewCellDelegate>
{
    
}
@end

@implementation DCShoppingTableView
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    ...
    DCShoppingModel *headModel = _shoppingArray[section];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (headModel.headState == 1) {
        ...
        DCShoppingBtn *collocationBtn = [[DCShoppingBtn alloc] initWithFrame:CGRectMake(0, 0, 55, 40)];
...
- (CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section
{
    ...
    DCShoppingModel *forModel = _shoppingArray[section];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    DCShoppingModel *model = _shoppingArray[section];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DCShoppingTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifer];
    if (cell == nil) {
        
        cell=[[DCShoppingTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifer];
        cell.delegate = self;
    }
    
    DCShoppingModel *shoppingmodel = _shoppingArray[indexPath.section];
...
-(void)ShoppingTableViewCell:(ShoppingCellModel *)model{
    ...
    DCShoppingModel *headmodel = _shoppingArray[model.section];
...
-(void)CollocationBtn:(UIButton *)sender{
    ...
    DCShoppingModel *model = _shoppingArray[sender.tag];
...
-(void)RefreshAllCellState:(DCShoppingModel *)model{
...
-(void)CalculationPrice{
    ...
    for (DCShoppingModel *model in _shoppingArray) {
...
-(NSArray *)RutrnCellModel:(DCShoppingModel *)model{
...
-(void)deleteBtn:(BOOL)isbool{
    ...
    for (DCShoppingModel *model in headDeleteArray) {
